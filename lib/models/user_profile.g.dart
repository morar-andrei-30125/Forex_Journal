...
UserProfile _userProfileDeserialize(
  ...
  final object = UserProfile(
    dateOfBirth: reader.readDateTimeOrNull(offsets[0]),
    firstName: reader.readString(offsets[1]),
    jobTitle: reader.readString(offsets[2]),
...
extension UserProfileQueryFilter
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> jobTitleEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> jobTitleBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> jobTitleMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByJobTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'jobTitle', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByJobTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByJobTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'jobTitle', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByJobTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'jobTitle', Sort.desc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByJobTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQueryProperty
  ...
  QueryBuilder<UserProfile, String, QQueryOperations> jobTitleProperty() {
    return QueryBuilder.apply(this, (query) {
